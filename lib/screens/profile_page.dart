                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: Center(
                          child: Text("Edit Profile",style: TextStyle(fontWeight: FontWeight.bold,color: Utils.baseColr,fontSize: screen?w*.03:h*.03),),
                        ),
                      ),
                    ],
                  ),
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    padding: EdgeInsets.only(left: 20,right: 20,top: screen?h*.1:w*.1),
                    child: CustomButton(
